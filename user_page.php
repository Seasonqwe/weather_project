...
<body>
    ...
    <div id="search-page" class="search-page">
        <div class="search-card">
            ...
            <div class="search-container">
                <input type="text" id="city" placeholder="Search for a city" onkeypress="if(event.key==='Enter') getWeather()">
    ...
    <div id="results-page" class="results-page hidden">
        ...
        <div class="header-search-bar hidden" id="header-search-bar">
            <input type="text" id="city-header" placeholder="Search for a city" onkeypress="if(event.key==='Enter') getWeather()">
            <button onclick="getWeather()">Search</button>
        </div>
